<?php
    ...
    if(isset($_POST['submit'])){
        if($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            $result_all = mysqli_query($con, $all_sql);
            ...
            if($nor > 0){
                ...
                if($pass1 != $cpass){
                    $error[] = "Password is doesn't matched..!";
                }else{
                    if(empty($fn)){
                    ...
                    $insert_sql = "INSERT INTO user_tbl(fname,lname,username,email,pass1,address_o,user_type,user_status) VALUES('$fn','$ln','$user','$email','$pass1','$address','user','1')";
        ...
        <div class="login-content">
            ...
            <div>
                <table border="0">
                    ...
                    <tr>
                        <td colspan="3">
                            <textarea name="address" cols="65" rows="10" placeholder="Enter Address"></textarea>
                        </td>
                    </tr>
